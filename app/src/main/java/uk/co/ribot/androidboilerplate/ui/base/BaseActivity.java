...
/**
 * Dagger Component の生成をする。
 *
 * すべての Activity がこいつを extend する
 * It handles
 * creation of Dagger components
 * and makes sure that instances of ConfigPersistentComponent survive
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // savedInstanceState が null か否かをチェックして、
        // ActivityId をシリアル番号のように生成 →追跡していく
